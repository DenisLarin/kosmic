...
public class CollectionKosmikServises {
    ...
    public CollectionKosmikServises(){
        try {
            ...
            kosmikServisesArrayList.add(new KosmikServises("10","1200","Ногди","Ж","nogti1 woman",new Image(new File("src/images/nogti1.jpg").toURI().toURL().toString())));
            kosmikServisesArrayList.add(new KosmikServises("11","1100","Ногди","Ж","nogti2 woman",new Image(new File("src/images/nogti2.jpg").toURI().toURL().toString())));
            ...
            kosmikServisesArrayList.add(new KosmikServises("17","1200","Волосы","М","volos2 man",new Image(new File("src/images/volosM2.jpg").toURI().toURL().toString())));
